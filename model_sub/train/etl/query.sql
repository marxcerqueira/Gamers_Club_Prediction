...
select 
    ...
    t1.avgFlWinner,
    t1.WinRateMirage,
    t1.RateqtMiragePartida,
    t1.WinRateNuke,
    t1.RateqtNukePartida,
    t1.WinRateInferno,
    t1.RateqtInfernoPartida,
    t1.WinRateVertigo,
    t1.RateqtVertigoPartida,
    t1.WinRateAncient,
    t1.RateqtAncientPartida,
    t1.WinRateDust2,
    t1.RateqtDust2Partida,
    t1.WinRateTrain,
    t1.RateqtTrainPartida,
    t1.WinRateOverpass,
    t1.RateqtOverpassPartida,
    t1.vlLevelAtual,
    t1.qtMedalDistict,
